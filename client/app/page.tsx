...
export default async function Home() {
  ...
  return (
    // <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen mx-autop-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
    <div className="container mx-auto max-w-[640px] shadow-lg h-full min-h-screen text-center flex flex-col items-center justify-center relative">
      <main>
